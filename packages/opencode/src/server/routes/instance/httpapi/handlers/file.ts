...
import { BrowseServiceMap, browseServiceMapLayer } from "@opencode-ai/core/location-services"
...
export const fileHandlers = HttpApiBuilder.group(InstanceHttpApi, "file", (handlers) =>
  Effect.gen(function* () {
    ...
    const locations = yield* BrowseServiceMap.Service
...
).pipe(Layer.provide(browseServiceMapLayer))
